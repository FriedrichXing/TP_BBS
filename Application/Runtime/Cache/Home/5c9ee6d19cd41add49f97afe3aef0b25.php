...
<body>
    ...
    <form name="myform" action="/TP_BBS/Home/User/checklog" method="post" class="form-signin" role="form">
        ...
        <button id="btn_login" class="btn btn-lg btn-primary btn-block">登录</button>
    </form>
